...
const Navbar = () => {
  ...
  useEffect(() => {
    setLogo(scrolled ? logoLight : logoDark);
  }, [scrolled]);
  ...
  return (
    ...
    >
      ...
      <ul className={`hidden md:flex space-x-8 ${scrolled ? "text-[#198A71]" : "text-white"}`}>
        <li className="hover:underline hover:opacity-70 cursor-pointer"><a href="#home">Home</a></li>
        <li className="hover:underline hover:opacity-70 cursor-pointer"><a href="#about">About Us</a></li>
        <li className="hover:underline hover:opacity-70 cursor-pointer"><a href="#principles">Principles</a></li>
        <li className="hover:underline hover:opacity-70 cursor-pointer"><a href="#meetups">Meetups</a></li>
        <li className="hover:underline hover:opacity-70 cursor-pointer"><a href="#events">Events</a></li>
        <li className="hover:underline hover:opacity-70 cursor-pointer"><Link to="/blogs">Blogs</Link></li>
      </ul>
      ...
      >
        <button onClick={() => setIsOpen(false)} className="absolute top-5 right-5 text-3xl text-white hover:opacity-70 cursor-pointer">
          <FiX />
        </button>
